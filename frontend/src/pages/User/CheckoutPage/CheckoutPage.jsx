  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 min-h-screen bg-gray-50 p-6">
      ...
      <div className="col-span-2 bg-white shadow rounded p-4">
        ...
        <AddressSection savedAddresses={savedAddresses} setSelectedAddressId={setSelectedAddressId} selectedAddressId={selectedAddressId}/>
      </div>
      {/* Coupon Section */}
      ...
      <CouponSection orderValue={cart.totalPrice} onDiscountApplied={handleDiscountApplied} selectedCoupon={selectedCoupon} setSelectedCoupon={setSelectedCoupon } />
        ...
        <PriceDetails cart={cart} discount={discount} finalPrice={finalPrice} selectedCoupon={selectedCoupon} selectedAddressId={selectedAddressId} setSelectedCoupon={setSelectedCoupon }/>
      </div>
    </div>
  );
}
